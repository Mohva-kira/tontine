    ...
    switch (activeTab) {
      case "Informations":
        return (
          <Specifics
            title="Mes infos"
            points={accountData.data[0]?.highlights?.Qualifications ?? ["N/A"]}
          />
        );
      case "A propos":
        return (
          <JobAbout info={accountData.data[0]?.highlights?.Description ?? "No data provided"} />
        );
      case "Historiques":
        return (
          <Specifics
            title="Mes transactions"
            points={accountData.data[0]?.highlights?.Responsibilities ?? ["N/A"]}
          />
        );
      default:
        break;
