...
export const customersData = [
  {
    ...
    CustomerImage:
      avatar,
    ProjectName: 'La famille',
    Status: 'Active',
    StatusBg: '#8BE78B',
    Weeks: '40',
    Budget: 320000.38.toLocaleString('fr') + ' Fcfa',
    Location: 'Rivera',
  },
  {
    CustomerID: 1002,
    ...
    ProjectName: 'Yopougon Millionnaire',
    Status: 'Active',
    CustomerImage:
      avatar3,
    ...
    StatusBg: '#8BE78B',
    Weeks: '11',
    Budget: 200000.00.toLocaleString('fr') + ' Fcfa',
    Location: 'Yopougon',
  },
  {
    CustomerID: 1003,

    CustomerName: 'Salimata',
    CustomerEmail: 'salimata@gmail.com',
    ProjectName: 'Ma voiture',
    Status: 'en attente',
    CustomerImage:
      avatar2,
    StatusBg: '#FEC90F',
    Weeks: '19',
    Budget: 350000.00.toLocaleString('fr') + ' Fcfa', 
    Location: 'Abidjan',
  },
  {
    CustomerID: 1004,
    ...
    ProjectName: 'Libère toi',
    Status: 'Completed',
    CustomerImage:
      avatar,
    StatusBg: '#8BE78B',
    Weeks: '34',
    Budget: 90000.31.toLocaleString('fr') + ' Fcfa',
    Location: 'Cocody',
  },
  {
    CustomerID: 1005,
    ...
    ProjectName: 'Ma tontine',
    Status: 'Cancel',
    CustomerImage:
      avatar4,
    StatusBg: 'red',
    Weeks: '34',
    Budget: 135000.99.toLocaleString('fr') + ' Fcfa',
    Location: 'Koumassi',
  },
  {
    CustomerID: 1006,
    CustomerName: 'Oumar Agbogbe',
    CustomerEmail: 'oumar@gmail.com',
    CustomerImage:
      avatar,
    ProjectName: 'Independant',
    Status: 'Active',
    StatusBg: '#8BE78B',
    Weeks: '40',
    Budget: 255000.99.toLocaleString('fr') + ' Fcfa',
    Location: 'Marcory',
  },
  {
    CustomerID: 1007,

    CustomerName: 'Aminata Keita',
    CustomerEmail: 'aminatakeita@gmail.com',
    ProjectName: 'Balimaya',
    Status: 'Active',
    CustomerImage:
      avatar3,
    ...
    StatusBg: '#8BE78B',
    Weeks: '11',
    Budget: 150000.99.toLocaleString('fr') + ' Fcfa',
    Location: 'Bamako',
  },
  {
    CustomerID: 1008,

    CustomerName: 'Brahim Souaré',
    CustomerEmail: 'brahimsoure@gmail.com',
    ProjectName: 'Entre aide, Yopougon Millionnaire',
    Status: 'en attente',
    CustomerImage:
      avatar4,
    StatusBg: '#FEC90F',
    Weeks: '19',
    Budget: 325000.99.toLocaleString('fr') + ' Fcfa',
    Location: 'Yopougon',
  },
  {
    CustomerID: 1009,

    CustomerName: 'Tidiane Touré',
    CustomerEmail: 'tidianetoure@gmail.com',
    ProjectName: 'Patriote',
    Status: 'Completed',
    CustomerImage:
      avatar,
    StatusBg: '#8BE78B',
    Weeks: '34',
    Budget: 195000.00.toLocaleString('fr') + ' Fcfa',
    Location: 'Palmerais',
  },
  {
    CustomerID: 1010,

    CustomerName: 'Frank Kouassi',
    CustomerEmail: 'frankkouassi@gmail.com',
    ProjectName: 'Fratrie',
    Status: 'Cancel',
    CustomerImage:
      avatar4,
    StatusBg: 'red',
    Weeks: '34',
    Budget: 2750000.99.toLocaleString('fr') + ' Fcfa',
    Location: 'Cocody',
  },
...
export const employeesData = [
  ...
  },
  {
    EmployeeID: 5,
    Name: 'Omar Ba',
    Title: 'Ingénieur(e) en test de logiciels',
    HireDate: '01/02/2021',
    Country: 'Abidjan',
    ReportsTo: 'Maxence',
    EmployeeImage:
  ...
  },
  {
    EmployeeID: 4,
    Name: 'Mariam Konate',
    Title: 'Responsable du marketing',
    HireDate: '01/02/2021',
    Country: 'Abidjan',
    ReportsTo: 'Mme Adu',
    EmployeeImage:
  ...
  {
    EmployeeID: 5,
    Name: 'Christine Kouakou',
    Title: 'Responsable de la relation clien',
    HireDate: '01/02/2021',
    Country: 'Abidjan',
    ReportsTo: 'Mme Adu',
    EmployeeImage:
...
export const ordersData = [
  {
    ...
    TotalAmount: 32000.38.toLocaleString('fr') + ' Fcfa',
    OrderItems: 'La famille',
    Location: 'Rivera',
    Status: 'en attente',
    StatusBg: '#FB9678',
    ProductImage:
  ...
  },
  {
    OrderID: 345653,
    CustomerName: 'Aminata',
    TotalAmount: 100000.00.toLocaleString('fr') + ' Fcfa',
    OrderItems: 'Yopougon Millionnaire',
    Location: 'Yopougon',
    Status: 'complete',
    StatusBg: '#8BE78B',
    ProductImage:
  ...
  },
  {
    OrderID: 390457,
    CustomerName: 'Salimata',
    TotalAmount: 60000.31.toLocaleString('fr') + ' Fcfa',
    OrderItems: 'Ma voiture',
    Location: 'Abidjan',
    Status: 'active',
    StatusBg: '#03C9D7',
    ProductImage:
  ...
  },
  {
    OrderID: 893486,
    CustomerName: 'Robert',
    TotalAmount: 45000.31.toLocaleString('fr') + ' Fcfa',
    OrderItems: 'Libère toi',
    Location: 'Cocody',
    Status: 'annulée',
    StatusBg: '#FF5C8E',
    ProductImage:
  ...
  },
  {
    OrderID: 748975,
    CustomerName: 'Mamadou',
    TotalAmount: 35000.99.toLocaleString('fr') + ' Fcfa',
    OrderItems: 'Ma tontine',
    Location: 'Koumassi',
    Status: 'rejeté',
    StatusBg: 'red',
    ProductImage:
  ...
  },
  {
    OrderID: 944895,
    CustomerName: 'Aminata Keita',
    TotalAmount: 150000.99.toLocaleString('fr') + ' Fcfa',
    OrderItems: 'Balimaya',
    Location: 'Bamako',
    Status: 'active',
    StatusBg: '#03C9D7',
  ...
  },
  {
    OrderID: 845954,
    CustomerName: 'Brahim Souaré',
    TotalAmount: 125000.99.toLocaleString('fr') + ' Fcfa',
    OrderItems: 'Entre aide',
    Location: 'Yopougon',
    Status: 'complete',
    StatusBg: '#8BE78B',
    ProductImage:
  ...
  {
    OrderID: 845954,
    CustomerName: 'Sori Diawara',
    TotalAmount: 85000.99.toLocaleString('fr') + ' Fcfa',
    OrderItems: 'Ton',
    Location: 'Cocody',
    Status: 'en attente',
    StatusBg: '#FB9678',
  ...
  },
  {
    OrderID: 874534,
    CustomerName: 'Tidiane Touré',
    TotalAmount: 95000.00.toLocaleString('fr') + ' Fcfa',
    OrderItems: 'Patriote',
    Location: 'Palmerais',
    Status: 'annulée',
    StatusBg: '#FF5C8E',
  ...
  {
    OrderID: 38489,
    CustomerName: 'Fofana Konaté',
    TotalAmount: 60000.00.toLocaleString('fr') + ' Fcfa',
    OrderItems: 'Sa',
    Location: 'Bamako',
    Status: 'active',
    StatusBg: '#03C9D7',
  ...
  },
  {
    OrderID: 24546,
    CustomerName: 'Frank Kouassi',
    TotalAmount: 750000.99.toLocaleString('fr') + ' Fcfa',
    OrderItems: 'Fratrie',
    Location: 'Cocody',
    Status: 'complete',
    StatusBg: '#8BE78B',
...
function changeDate (date, members, Periodicite) {
  
  let laDate = new Date(date);

  if (Periodicite === "Hebdomadaire") {
    let weeksToMonth = Number(members) * 7 / 30

     return new Date(laDate.setMonth(laDate.getMonth() + weeksToMonth)).toLocaleDateString() ;
  } else {
    return new Date(laDate.setMonth(laDate.getMonth() + Number(members))).toLocaleDateString();

  }
};

function nextDueDate(date, members, periodicite) {
  let laDate = new Date();

  if (periodicite === "Hebdomadaire") {
    

     return new Date(laDate.setDate(laDate.getDate() + 7 )).toLocaleDateString() ;
  } else {
    return new Date(laDate.setMonth(laDate.getMonth() + 1)).toLocaleDateString();

  }
}

export const tontinesData = [
  {
    TontineID: 10248,
    CustomerName: 'Moussa',

    TotalAmount: 640000.38.toLocaleString('fr') + ' Fcfa',
    OrderItems: 'La famille',
    Location: 'Rivera',
    Status: 'en attente',
    StatusBg: '#FB9678',
    members: '20',
    MembersList: [{name: 'Alain', paid: true},  {name: 'Fatoumata', paid: true},  {name: 'Rogers', paid: false}, {name: 'Amadou', paid: true}, {name: 'Mariam', paid: true}, {name: 'Zoumana', paid: true}, {name: 'Elise', paid: false}, {name: 'Kouakou', paid: false}, {name: 'Stephanie', paid: true}],
    Periodicite: 'Hebdomadaire',
    Date_debut: new Date('2023-03-8').toLocaleDateString(),
    Date_fin: changeDate('2023-03-13', '20', 'Hebdomadaire'),
    nextDueDate: nextDueDate('2023-03-13', '20', 'Hebdomadaire'),
    lastDueDate: new Date('2023-03-15').toLocaleDateString(),
    ProductImage:
      product6,
  },
  {
    TontineID: 345653,
    CustomerName: 'Aminata',
    TotalAmount: 1500000.00.toLocaleString('fr') + ' Fcfa',
    OrderItems: 'Yopougon Millionnaire',
    Location: 'Yopougon',
    Status: 'complete',
    StatusBg: '#8BE78B',
    ...
    Date_fin: changeDate('2023-03-05', '15', 'Mois'),
    lastDueDate: new Date('2023-03-05').toLocaleDateString(),
    ProductImage:
      product5,
  },
  {
    TontineID: 390457,
    CustomerName: 'Salimata',
    TotalAmount: 600000.31.toLocaleString('fr') + ' Fcfa',
    OrderItems: 'Ma voiture',
    Location: 'Abidjan',
    Status: 'active',
    StatusBg: '#03C9D7',
    ...
    Date_fin: changeDate('2023-04-15', '10', 'Mois'),
    lastDueDate: new Date('2023-04-15').toLocaleDateString(),
    ProductImage:
      product7,
  },
  {
    TontineID: 893486,
    CustomerName: 'Robert',
    TotalAmount: 1200000.31.toLocaleString('fr') + ' Fcfa',
    OrderItems: 'Libère toi',
    Location: 'Cocody',
    Status: 'annulée',
    StatusBg: '#FF5C8E',
    members: '25',
    Periodicite: 'Hebdomadaire',
    Date_debut: '2023-03-24',
    Date_fin: changeDate('2023-03-24', '25', 'Hebdomadaire'),
    lastDueDate: new Date('2023-03-24').toLocaleDateString(),
    ProductImage:
      product4,
  },
  {
    TontineID: 748975,
    CustomerName: 'Mamadou',
    TotalAmount: 450000.99.toLocaleString('fr') + ' Fcfa',
    OrderItems: 'Ma tontine',
    Location: 'Koumassi',
    Status: 'rejeté',
    StatusBg: 'red',
    members: '15',
    Periodicite: 'Mois',
    Date_debut: '2023-04-11',
    Date_fin: changeDate('2023-04-11', '15', 'Mois'),
    lastDueDate: new Date('2023-04-11').toLocaleDateString(),
    ProductImage:
    product1,
  },
  {
    TontineID: 94757,
    CustomerName: 'Oumar Agbogbe',
    TotalAmount: 350000.99.toLocaleString('fr') + ' Fcfa',
    OrderItems: 'Independant',
    Location: 'Marcory',
    Status: 'annulée',
    StatusBg: '#FF5C8E',
    ...
    Date_fin: changeDate('2023-04-20', '10', 'Mois'),
    lastDueDate: new Date('2023-04-20').toLocaleDateString(),
    ProductImage:
      product2,
  },
  {
    TontineID: 944895,
    CustomerName: 'Aminata Keita',
    TotalAmount: 4500000.99.toLocaleString('fr') + ' Fcfa',
    OrderItems: 'Balimaya',
    Location: 'Bamako',
    Status: 'active',
    StatusBg: '#03C9D7',
    members: '30',
    Periodicite: 'Hebdomadaire',
    Date_debut: '2023-05-5',
    Date_fin: changeDate('2023-05-5', '30', 'Hebdomadaire'),
    lastDueDate: new Date('2023-05-5').toLocaleDateString(),
    ProductImage:
      product3,
  },
  {
    TontineID: 845954,
    CustomerName: 'Brahim Souaré',
    TotalAmount: 2500000.99.toLocaleString('fr') + ' Fcfa',
    OrderItems: 'Entre aide',
    Location: 'Yopougon',
    Status: 'complete',
    StatusBg: '#8BE78B',
    ...
    Date_fin: changeDate('2023-04-14', '20', 'Mois'),
    lastDueDate: new Date('2023-04-14').toLocaleDateString(),
    ProductImage:
     'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTir7mxMd4VZqxD7RP8fUdWHXVkM94hx0g8Z_hkHf77EUAj10TzqNpLxv82UNfsGR5fBkg&usqp=CAU',
  },
  {
    TontineID: 845954,
    CustomerName: 'Sori Diawara',
    TotalAmount: 1275000.99.toLocaleString('fr') + ' Fcfa',
    OrderItems: 'Ton',
    Location: 'Cocody',
    Status: 'en attente',
    StatusBg: '#FB9678',
    members: '15',
    Periodicite: 'Mois',
    Date_debut: '2023-04-04',
    Date_fin: changeDate('2023-04-04', '15', 'Mois'),
    lastDueDate: new Date('2023-04-04').toLocaleDateString(),
  ...
  },
  {
    TontineID: 874534,
    CustomerName: 'Tidiane Touré',
    TotalAmount: 1330000.00.toLocaleString('fr') + ' Fcfa',
    OrderItems: 'Patriote',
    Location: 'Palmerais',
    Status: 'annulée',
    StatusBg: '#FF5C8E',
    members: '14',
    Periodicite: 'Mois',
    Date_debut: '2023-04-08',
    Date_fin: changeDate('2023-04-08', '14', 'Mois'),
    lastDueDate: new Date('2023-04-08').toLocaleDateString(),
    ProductImage:
      "https://static8.depositphotos.com/1008611/883/v/600/depositphotos_8833952-stock-illustration-africa-continent-flag-map.jpg",
  },
  {
    TontineID: 38489,
    CustomerName: 'Fofana Konaté',
    TotalAmount: 1380000.00.toLocaleString('fr') + ' Fcfa',
    OrderItems: 'Sa',
    Location: 'Bamako',
    Status: 'active',
    StatusBg: '#03C9D7',
    ...
    Periodicite: 'Mois',
    Date_debut: '2023-04-15',
    Date_fin: changeDate('2023-04-15', '23', 'Mois'),
    lastDueDate: new Date('2023-04-15').toLocaleDateString(),
    ProductImage:
      product5,
  },
  {
    TontineID: 24546,
    CustomerName: 'Frank Kouassi',
    TotalAmount: 6000000.99.toLocaleString('fr') + ' Fcfa',
    OrderItems: 'Fratrie',
    Location: 'Cocody',
    Status: 'complete',
    StatusBg: '#8BE78B',
    members: '8',
    Periodicite: 'Mois',
    Date_debut: '2023-02-03',
    Date_fin: changeDate('2023-02-03', '8', 'Mois'),
    lastDueDate: new Date('2023-04-03').toLocaleDateString(),
    ProductImage:
    "https://us.123rf.com/450wm/grivina/grivina2004/grivina200400022/145247816-heureuse-famille-internationale-avec-enfants-sant%C3%A9-et-bien-%C3%AAtre-de-la-famille-concept-vectoriel.jpg?ver=6"
  },
  {
    TontineID: 874534,
    CustomerName: 'Danai',
