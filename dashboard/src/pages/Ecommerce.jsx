        ...
        <div className="bg-white dark:text-gray-200 dark:bg-secondary-dark-bg h-44 rounded-xl w-full lg:w-80 p-8 pt-9 m-3 bg-hero-pattern bg-no-repeat bg-cover bg-center">
          <div className="flex justify-between items-center">
            <div>
              ...
              <p className='text-2xl'>63 510 448 Fcfa</p>
            </div>
          </div>
          <div className='mt-6'>
            <Button 
      ...
      <div className='flex w-full gap-10 flex-wrap justify-center'>
          <div className="bg-white dark:text-gray-200 dark:bg-secondary-dark-bg m-3 rounded-2xl w-full">
            <div className="flex justify-between">
              <p className='font-semibold text-xl'>Mise à jour des revenus</p>
            ...
            <div className="mt-10 flex gap-10 flex-wrap justify-center">
              <div className="border-r-1 border-colo m-4 pr-10" >
                <div>
                  <p>
                    <span className='text-3xl font-semibold'> 63 438 330 Fcfa</span>
                    <span className='p-1.5 hover:drop-shadow-xl cursor-pointer rounded-full text-white bg-green-400 ml-3 text-xs'>23%</span>
                  
                  </p>
                  <p className='text-gray-500 mt-1'>Chiffre d'affaires</p>
                </div>
                <div className='mt-8'>
                  <p>
                    <span className='text-3xl font-semibold'>14 438 500 Fcfa</span>
                   
                  
                  </p>
                  <p className='text-gray-500 mt-1'>Commission</p>
                </div>
